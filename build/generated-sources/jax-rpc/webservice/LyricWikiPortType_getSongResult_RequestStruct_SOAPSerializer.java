...
public class LyricWikiPortType_getSongResult_RequestStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public LyricWikiPortType_getSongResult_RequestStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        webservice.LyricWikiPortType_getSongResult_RequestStruct instance = new webservice.LyricWikiPortType_getSongResult_RequestStruct();
        webservice.LyricWikiPortType_getSongResult_RequestStruct_SOAPBuilder builder = null;
        ...
        for (int i=0; i<2; i++) {
            ...
            if (elementName.equals(ns1_artist_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new webservice.LyricWikiPortType_getSongResult_RequestStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        webservice.LyricWikiPortType_getSongResult_RequestStruct instance = (webservice.LyricWikiPortType_getSongResult_RequestStruct)obj;
