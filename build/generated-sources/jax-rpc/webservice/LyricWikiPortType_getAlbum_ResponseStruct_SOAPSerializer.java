...
public class LyricWikiPortType_getAlbum_ResponseStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    private static final int myAMAZONLINK_INDEX = 3;
    private static final int myIMGURL_INDEX = 4;
    private static final int myURL_INDEX = 5;
    private static final int mySONGS_INDEX = 6;
    
    public LyricWikiPortType_getAlbum_ResponseStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        webservice.LyricWikiPortType_getAlbum_ResponseStruct instance = new webservice.LyricWikiPortType_getAlbum_ResponseStruct();
        webservice.LyricWikiPortType_getAlbum_ResponseStruct_SOAPBuilder builder = null;
        ...
        for (int i=0; i<7; i++) {
            ...
            if (elementName.equals(ns1_artist_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new webservice.LyricWikiPortType_getAlbum_ResponseStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        webservice.LyricWikiPortType_getAlbum_ResponseStruct instance = (webservice.LyricWikiPortType_getAlbum_ResponseStruct)obj;
