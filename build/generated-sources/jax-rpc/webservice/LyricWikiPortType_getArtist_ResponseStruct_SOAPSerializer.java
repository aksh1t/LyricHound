...
public class LyricWikiPortType_getArtist_ResponseStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    private static final int myALBUMS_INDEX = 1;
    
    public LyricWikiPortType_getArtist_ResponseStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        webservice.LyricWikiPortType_getArtist_ResponseStruct instance = new webservice.LyricWikiPortType_getArtist_ResponseStruct();
        webservice.LyricWikiPortType_getArtist_ResponseStruct_SOAPBuilder builder = null;
        ...
        for (int i=0; i<2; i++) {
            ...
            if (elementName.equals(ns1_artist_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new webservice.LyricWikiPortType_getArtist_ResponseStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        webservice.LyricWikiPortType_getArtist_ResponseStruct instance = (webservice.LyricWikiPortType_getArtist_ResponseStruct)obj;
