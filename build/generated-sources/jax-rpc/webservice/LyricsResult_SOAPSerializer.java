...
public class LyricsResult_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public LyricsResult_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        webservice.LyricsResult instance = new webservice.LyricsResult();
        webservice.LyricsResult_SOAPBuilder builder = null;
        ...
        for (int i=0; i<4; i++) {
            ...
            if (elementName.equals(ns1_artist_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new webservice.LyricsResult_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        webservice.LyricsResult instance = (webservice.LyricsResult)obj;
