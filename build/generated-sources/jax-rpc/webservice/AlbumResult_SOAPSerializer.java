...
public class AlbumResult_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public AlbumResult_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        webservice.AlbumResult instance = new webservice.AlbumResult();
        webservice.AlbumResult_SOAPBuilder builder = null;
        ...
        for (int i=0; i<3; i++) {
            ...
            if (elementName.equals(ns1_artist_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new webservice.AlbumResult_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        webservice.AlbumResult instance = (webservice.AlbumResult)obj;
